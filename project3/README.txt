...
-CSCE 274 Project 3-
--------------------
The third project in CSCE274 implements a PD controller for
the iRobot Create2. This PD controller, using values from
infrared sensors, will let the robot 'follow' a wall at a
specific distance.   
  ...
  3. Transfer all needed files (again, they're listed above)
     ...
     the below command in the terminal:
       $ scp SerialInterface.py RobotInterface.py
             Main_Project3.py pi@192.168.1.1:~/
